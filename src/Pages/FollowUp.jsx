...
function FollowUp() {
  ...
  return (
    <div className="p-4 flex gap-4 z-20">
      ...
      <div className="w-[24vw] bg-white rounded-xl p-4 shadow border border-gray-200 h-[81.5vh] flex flex-col">
  <div className="flex justify-between border-b pb-2 mb-3 shrink-0">
    <button
  ...
  <div className="flex-1 overflow-hidden hover:overflow-y-auto pr-1" style={{ maxHeight: 'calc(81.5vh - 60px)' }}>
    {activeTab === 'calls' && (
      <>
